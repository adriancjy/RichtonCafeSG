...
const OrderSummary = props => (
    <table>
        {props.selectedsummary.start == "true" && <thead>
            <tr>
                <th style={cartStyle}>
        ...
        <tbody>
            <tr>
                ...
                <td style={cartStyle2}>{props.selectedsummary.mquantity}</td>
                <td style={cartStyle3}>{props.selectedsummary.mprice}</td>
            </tr>
            <tr>
                <td style={cartStyle}>{props.selectedsummary.slabel}</td>
                <td style={cartStyle2}>{props.selectedsummary.quantity}</td>
                <td style={cartStyle3}>{props.selectedsummary.sprice}</td>
            </tr>
            <tr>
